        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            $('body').append('<div class="modal" id="session-timeout-dialog"> \
                <div class="modal-content"> \
                  <div class="modal-header"> \
                    <h4 class="modal-title text-center"> ' + opt.title + '</h4> \
                  </div> \
             ...
             <button id="session-timeout-dialog-logout" type="button" class="btn grey lighten-1" style="margin-right:5px;">' + opt.logoutButton + '</button> \
             <button id="session-timeout-dialog-keepalive" type="button" class="btn indigo darken-4 " data-dismiss="modal">' + opt.keepAliveButton + '</button> \
            </div> \
                </div> \
             </div>');
            ...
            $('#session-timeout-dialog-keepalive').on('click', function() {
                ...
                var request = $.ajax({
					...
					data: JSON.stringify({
                        action: 'stay-connected-btn',
                        annotation_type: opt.annotation_type,
                        task_id: task_id,
