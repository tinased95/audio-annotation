...
WaveSurfer.Regions = {
    ...
    add: function (params) {
        ...
        // console.log(params, this.wavesurfer)
...
WaveSurfer.Region = {
    ...
    updateRender: function (pxPerSec) {
        ...
        // }
        // console.log(this.maxLength, this.minLength)
        ...
        if (this.handleLeft != null) {
            // this.handleLeft.innerHTML = (this.start).toFixed(2); //if you want to show the red handle
        ...
        if (this.handleRight != null) {
            // this.handleRight.innerHTML = (this.end).toFixed(2);
    ...
    bindEvents: function () {
        ...
        this.element.addEventListener('click', function (e) { // clicking a part (cursor)
